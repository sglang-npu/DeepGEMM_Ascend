...
#ifndef CATLASS_PADDING_STREAMK_MATMUL_KERNEL_H
#define CATLASS_PADDING_STREAMK_MATMUL_KERNEL_H
...
__aicore__ inline void PaddingStreamkMatmulKernel(GM_ADDR gmA, GM_ADDR gmB, GM_ADDR gmC, GM_ADDR gmW,
    const CatlassDynamicMatmulTilingData &tilingData)
{
    ...
    GM_ADDR gmReduceW = gmW + sizeWA + sizeWB;
    ...
    typename MatmulKernel::Params params{
        ...
        gmWA, gmWB, gmReduceW, swizzleOffset, swizzleDirection};
    // call a kernel
    MatmulKernel matmul;
...
template <class InDtype, class OutDtype, uint32_t LAYOUT_TAGA, uint32_t LAYOUT_TAGB, uint32_t LAYOUT_TAGC,
    uint32_t PADDING_TAGA, uint32_t PADDING_TAGB>
__aicore__ inline void PaddingStreamkMatmulKernelWrapper(
    GM_ADDR gmA, GM_ADDR gmB, GM_ADDR gmC, GM_ADDR gmW, const CatlassDynamicMatmulTilingData &tilingData)
{
    ...
    PaddingStreamkMatmulKernel<InDtype, LayoutA, InDtype,
        LayoutB, OutDtype, LayoutC, paddingTagA, paddingTagB>(gmA, gmB, gmC, gmW, tilingData);
}
} // namespace DynamicKernel
#endif // CATLASS_PADDING_STREAMK_MATMUL_KERNEL_H