...
class CatlassParameter:
    ...
    def __init__(self, operator_type, core_num=20, layout_tag_a=None, layout_tag_b=None):
        ...
        Args:
            operator_type: 算子类型，必须提供，可选值: 
                - 'SmallMatmul': SmallMatmul算子
                - 'CommonMatmul': CommonMatmul算子
                - 'PaddingCommonMatmul': PaddingCommonMatmul算子
                - 'PaddingMultiCoreSplitkMatmul': PaddingMultiCoreSplitkMatmul算子
                - 'PaddingStreamkMatmul': PaddingStreamkMatmul算子
    ...
    def filter_parameters(self, shape, layout_tag_a=None, layout_tag_b=None):
        ...
        constraint_checkers = {
            'smallmatmul': self.check_smallmatmul_constraints,
            'paddingcommonmatmul': self.check_padding_common_matmul_constraints,
            'paddingmulticoresplitkmatmul': self.check_padding_multicore_splitk_constraints,
            'paddingstreamkmatmul': self.check_padding_streamk_constraints,
            'commonmatmul': self.check_commonmatmul_constraints,
        }
